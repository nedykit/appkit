...
import '@nedykit/appkit-ui/src/composites/wui-card-select-loader'
import type { WuiCardSelectLoader } from '@nedykit/appkit-ui/src/composites/wui-card-select-loader'
