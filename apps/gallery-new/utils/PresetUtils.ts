import type { TransactionStatus } from '@nedykit/appkit-common'
import type { TransactionType } from '@nedykit/appkit-ui-new'
import type {
  AccountEntryType,
  BackgroundType,
  BorderRadiusType,
  ...
  ToastMessageVariant,
  VisualType
} from '@nedykit/appkit-ui-new/src/utils/TypeUtil'
