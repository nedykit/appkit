...
import '@nedykit/appkit-ui-new/src/composites/wui-compatible-network'
import type { WuiCompatibleNetwork } from '@nedykit/appkit-ui-new/src/composites/wui-compatible-network'
